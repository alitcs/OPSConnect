# ConnectOPS — Cost Breakdown & Financial Model (Working Document)

> **Purpose of this file.** This is a *launching point* for the team to build out the cost side of the
> ConnectOPS proposal in more depth. It consolidates **every cost figure already in our slides and
...
contradict them without updating both source documents (`ConnectOPS_Presentation.md` and
`ConnectOPS_Executive_Summary.html`).
...
- **Single source of truth:** if any number changes here, update **both**
  [ConnectOPS_Presentation.md](ConnectOPS_Presentation.md) and
  [ConnectOPS_Executive_Summary.html](ConnectOPS_Executive_Summary.html).
